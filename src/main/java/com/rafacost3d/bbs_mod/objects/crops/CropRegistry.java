...
public class CropRegistry {
    ...
    private static final HashMap<String, BlockBBSCrop> crops = new HashMap<String, BlockBBSCrop>();
    ...
    public static HashMap<String, BlockBBSCrop> getCrops() {
        if(!isInitialized) {
            FMLLog.bigWarning("Crop registry is not initialized.");
            return new HashMap<String, BlockBBSCrop>();
        }
        return crops;
    }
